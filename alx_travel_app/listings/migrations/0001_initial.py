...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('rating__gte', 1), ('rating__lte', 5)), name='valid_rating_range'), models.UniqueConstraint(fields=('property', 'user'), name='unique_user_review_per_property')],
            },
        ),
    ]
